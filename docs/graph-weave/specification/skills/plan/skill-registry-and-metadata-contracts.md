# Skill Discovery and Metadata Contracts
...
- `[[../examples/README]]` describes the purpose of example skill docs and discovery/cache behavior. This reference matters because examples show how the metadata contract is consumed.
...
- The discovery and metadata contract are documented in one place.
