...
Workflow:
1. Activate the skill to load its instructions.
2. Execute the skill action.
3. Return the result clearly.

Only make one function call per response.
...
"""
    ...
    def _execute(self, func: Dict) -> Dict:
        ...
        if name == "activate_skill":
            ...
            result = (
                {"success": bool(content), "instructions": content}
                if content
