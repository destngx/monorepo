...
describe('Sheet Mappers', () => {
  ...
  describe('mapTransaction', () => {
    it('maps a full valid transaction with raw values', () => {
      const row = ['Vietcombank', '45658', 'REF123', 'Grocery', 'food, household', 'Weekly shopping', 'Groceries', '✓', '150000', '', '500000', '500000', '350000'];
    ...
    it('handles various cleared statuses correctly', () => {
      ...
      expect(mapTransaction(['Cash', '', '', 'P', '', '', 'Cat', 'Yes', '1000', '', '', '', ''], 1)!.cleared).toBe(true);
