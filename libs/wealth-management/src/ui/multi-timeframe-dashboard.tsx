...
import { Card, CardContent, CardHeader, CardTitle, Badge, Label, MarketSignalCard, IntelligenceBanner, TimeframeRelationshipGrid, TechnicalAnalysisView } from '@wealth-management/ui';
import {
  History,
  ArrowRight,
  Clock,
...
// Use same design token as in the library
const GLASS_CARD =
