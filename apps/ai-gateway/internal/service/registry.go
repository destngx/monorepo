...
func NewRegistry(cfg *config.Config) *Registry {
	...
	r.register(shared.NewRateLimitedProvider(
		github_copilot.New(cfg.GitHubToken, cfg.GitHubAccountType, cfg.Verbose, github_copilot.ClientHeaders{
			EditorVersion:       cfg.CopilotEditorVersion,
			EditorPluginVersion: cfg.CopilotEditorPluginVersion,
