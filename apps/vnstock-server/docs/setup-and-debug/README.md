...
> _"Bạn không cần phải là một hards-code engineer để phân tích dữ liệu chứng khoán. Hãy để AI làm người trợ lý kỹ thuật (Pair Programmer) của bạn."_
...
1. [**Hướng Dẫn Deployment (Cho AI Agent)**](04-deployment-guide.md)
