        ...
        <CardContent className="p-6">
          <div className="flex justify-between items-start mb-6">
            <div className="flex items-center gap-3">
              <div className="text-3xl grayscale group-hover:grayscale-0 transition-all duration-300">{goal.emoji}</div>
              <div>
            ...
            <Badge
              variant="outline"
              className={cn('text-[10px] font-bold uppercase py-0 px-1.5', statusColors[goal.status])}
            >
