        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            <div className="flex items-center gap-2 mb-1">
              <span className="text-[10px] font-black uppercase tracking-[0.2em] text-blue-500 bg-blue-500/10 px-2 py-0.5 rounded">Credit Module</span>
            </div>
                 ...
                 <div className="flex items-start gap-4">
                   ...
                   <div className="space-y-1">
                     ...
                     <p className="text-xs text-muted-foreground leading-relaxed">
                        To maintain a healthy credit score, try keeping your utilization below 30% (<MaskedBalance amount={limit * 0.3} />).
                     </p>
                   </div>
                 </div>
              </CardContent>
                 ...
                 <div key={i} className="flex items-center justify-between p-4 hover:bg-muted/50 transition-colors">
                   <div className="flex items-center gap-3">
                     ...
                     <div>
                       ...
                       <p className="text-[10px] text-muted-foreground uppercase tracking-widest">{t.category} · {new Date(t.date).toLocaleDateString()}</p>
                     </div>
                   </div>
           ...
           <div className="p-6 rounded-2xl bg-muted/20 border border-white/5 space-y-4">
             ...
             <div className="space-y-2">
               {['Lock Card', 'Change PIN', 'Contact Support'].map(item => (
                 <button key={item} className="w-full flex items-center justify-between p-3 rounded-xl hover:bg-muted transition-colors text-sm font-medium">
                   {item}
