        ...
        <Card className="shadow-sm border-emerald-200 bg-emerald-50/50">
           ...
           <CardContent className="space-y-4">
              <div className="bg-white p-4 rounded-lg shadow-sm border border-emerald-100">
                 ...
                 <p className="text-xs text-muted-foreground">You are saving over 30% of your income consistently over the last 3 months.</p>
              </div>
              <div className="bg-white p-4 rounded-lg shadow-sm border border-emerald-100">
                 <h4 className="font-semibold text-sm mb-1">Low Debt Utilization</h4>
                 <p className="text-xs text-muted-foreground">Your outstanding credit card balances are extremely low compared to your assets.</p>
              </div>
           </CardContent>
        </Card>
        ...
        <Card className="shadow-sm border-amber-200 bg-amber-50/50">
           ...
           <CardContent className="space-y-4">
              <div className="bg-white p-4 rounded-lg shadow-sm border border-amber-100">
                 ...
                 <p className="text-xs text-muted-foreground">Your spending on Food Delivery has increased by 45% this month. Consider cooking at home to stay within budget.</p>
              </div>
              <div className="bg-white p-4 rounded-lg shadow-sm border border-amber-100">
                 <h4 className="font-semibold text-sm mb-1">Emergency Fund Gap</h4>
                 <p className="text-xs text-muted-foreground">Your emergency fund currently covers 2 months of expenses. The target is 6 months.</p>
              </div>
           </CardContent>
        </Card>
      </div>
