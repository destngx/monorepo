...
import { ArrowLeft, Plus, Calendar, Target, ShieldCheck, History as HistoryIcon, Sparkles, TrendingUp } from "lucide-react";
    ...
    <div className="max-w-4xl mx-auto space-y-8 pb-20">
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
           <Badge variant="outline" className="bg-indigo-500/5 text-indigo-500 border-indigo-500/20 px-3 py-1 font-bold uppercase tracking-tighter text-[10px]">
             AI Managed
           </Badge>
        </div>
      </div>
        ...
        <div className="relative flex flex-col items-center text-center space-y-6">
          ...
          <div className="grid grid-cols-3 gap-8 w-full pt-4">
            <div className="text-center">
              ...
              <p className="text-xl font-bold"><MaskedBalance amount={goal.currentAmount} /></p>
            </div>
            <div className="text-center">
              <p className="text-xs uppercase tracking-widest text-white/50 mb-1 font-bold">Remaining</p>
              <p className="text-xl font-bold"><MaskedBalance amount={goal.targetAmount - goal.currentAmount} /></p>
            </div>
            <div className="text-center">
            ...
            <CardContent className="p-6">
              <div className="flex items-center justify-between mb-6">
                ...
                <div className="flex gap-1">
                   {["W", "M", "Y", "ALL"].map(t => (
                     <Button key={t} variant="ghost" size="sm" className={cn("h-7 px-2 text-[10px] font-bold", t === "M" && "bg-muted text-foreground")}>
                       {t}
                     </Button>
                   ))}
                </div>
          ...
          <Card className="border-dashed border-2 bg-indigo-500/5 hover:bg-indigo-500/10 transition-colors cursor-pointer group">
             <CardContent className="p-6 space-y-3">
                ...
                <p className="text-sm text-balance leading-relaxed">
                  You've maintained a <span className="font-bold">12-week streak</span>! You're just <span className="font-bold">₫5.0M</span> away from your next 75% milestone.
                </p>
